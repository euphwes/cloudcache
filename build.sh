...
uglifyjs cloudcache/assets/js/jquery-2.1.0.min.js cloudcache/assets/js/bootstrap.min.js cloudcache/assets/js/jquery-confirm.min.js cloudcache/assets/js/icheck.min.js cloudcache/assets/js/enquire.min.js cloudcache/assets/js/handlebars.js cloudcache/assets/js/cloudcache/app.js cloudcache/assets/js/jquery.mCustomScrollbar.concat.min.js -c -o cloudcache/static/js/cc.min.js 2> err.tmp
